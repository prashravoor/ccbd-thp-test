...
DATE=$(date +"%d%m%Y%H%M")
scp root@$HOST:$dir/\{memusage_*,perf.data_*,frag_*,thp_stats_*,pfaults_*,mongopid\} monitoring
...
tar -cf $tarball $WL_PROFILE logs/wl_* logs/errors_* logs/json_* monitoring/memusage_* logs/hdr/*.hdr monitoring/perf.data_* monitoring/frag_* monitoring/thp_stats_* monitoring/pfaults_* monitoring/mongopid
